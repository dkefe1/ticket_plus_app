...
class HotTickets extends StatefulWidget {
  const HotTickets({super.key});

  @override
  State<HotTickets> createState() => _HotTicketsState();
}

class _HotTicketsState extends State<HotTickets> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: myAppBar(context, "Hot Tickets"),
