...
class PassedTicketsTab extends StatefulWidget {
  const PassedTicketsTab({super.key});

  @override
  State<PassedTicketsTab> createState() => _PassedTicketsTabState();
}

class _PassedTicketsTabState extends State<PassedTicketsTab> {
      ...
      body: BlocConsumer<TicketBloc, TicketState>(
        ...
        builder: (context, state) {
          ...
          if (state is GetTicketLoadingState) {
            ...
            if (state.error ==
                "ClientException with SocketException: Failed host lookup: 'tiket-plus-dev-api.onrender.com' (OS Error: No address associated with hostname, errno = 7), uri=https://tiket-plus-dev-api.onrender.com/api/v1/eventticket") {
